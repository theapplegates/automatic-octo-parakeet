...
var DEFAULT_THEME = {
  ...
  feedback: {
    content: () => /* @__PURE__ */ React39.createElement(React39.Fragment, null, "Question? Give us feedback \u2192"),
    labels: "feedback"
  },
  footer: {
    component: Footer,
  ...
  search: {
    component({ className, directories }) {
      const config = useConfig();
      return config.flexsearch ? /* @__PURE__ */ React39.createElement(Flexsearch, {
        className
...
var InnerLayout = ({
  ...
  }), /* @__PURE__ */ React44.createElement(Head, null), /* @__PURE__ */ React44.createElement(Banner, null), themeContext.navbar && renderComponent(config.navbar.component, {
    flatDirectories,
